...
echo "  3. Create matching tab groups: tmux-chrome grab"
echo "  4. Switch tmux windows → Chrome tab groups auto-switch"
echo ""
echo "Commands:"
echo "  tmux-chrome list              # List tab groups"
echo "  tmux-chrome add <url>         # Add URL to current window's group"
echo "  tmux-chrome grab              # Extract URLs from panes → fzf → add"
echo "  tmux-chrome tabs              # Browse group tabs via fzf"
echo "  tmux-chrome tabs --all        # Browse all tabs via fzf"
echo "  tmux-chrome delete            # Delete current window's group"
